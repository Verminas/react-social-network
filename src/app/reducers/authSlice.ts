...
const slice = createAppSlice({
  ...
  reducers: (creators) => {
    ...
    return {
      initializeApp: createAThunk<AuthReducerInitialType>(async (_, thunkAPI) => {
      ...
      logIn: createAThunk<AuthReducerInitialType, UserLogInRequestType>(async (arg, thunkAPI) => {
        const {dispatch, rejectWithValue} = thunkAPI
      ...
      logOut: createAThunk<AuthReducerInitialType>(async(arg, thunkAPI) => {
