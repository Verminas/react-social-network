...
const slice = createAppSlice({
  ...
  reducers: (creators) => {
    ...
    return {
      getUserStatus: createAThunk<UserStatusStateType, number>(async (userId, thunkAPI) => {
        const {} = thunkAPI
      ...
      updateUserStatus: createAThunk<UserStatusStateType, {userId: number, title: string}>(async (arg, thunkAPI) => {
